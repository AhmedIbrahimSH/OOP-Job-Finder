...
public class MainClass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ArrayList <String> email_for_newApplicants = null;
				...
				if(lookingforajob.toLowerCase().equals("yes")) {
					...
					while(apply.toLowerCase().equals("no")) {
						...
						for(int i = 0 ; i < (all_companies.size()) ; i++){
							System.out.println();
							Thread.sleep(1500);
							System.out.println("Offered by \"" + all_companies.get(i).getName() + "\" : ");
							System.out.println();
							Thread.sleep(1500);
						...
						int x = input.nextInt();
						System.out.println("Did you want to apply for the  " + AllJobs.get(x-1).getJobName()+ " job ? ");
						Thread.sleep(1500);
						System.out.println();
						System.out.println("Enter Yes to ensure your application , other wise no ");
					...
					if(apply.toLowerCase().equals("yes")) {
						...
						for(int i = 0 ; i < JobSeekers.size()	; i++) {
							...
							if(email == JobSeekers.get(i).getEmail()) {
								JobSeeker new_applicant = JobSeekers.get(i);
					...
					if(result2.toLowerCase().equals("yes")) {
						...
						for(int i = 0 ; i < all_companies.size(); i++) {
							...
							if(nameofcompany.equals(all_companies.get(i).getName())) {
								found = 1;
